...
//INSTANCE FOR A REFERENCE IN FIREBASE
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          SizedBox(height: 15),
          Expanded(
            ///The FirebaseAnimatedList widget is used to display a list of albums fetched from the database in real-time.
            ///Each item in the list is represented by a ListTile containing album details,
            ...
            child: FirebaseAnimatedList(
              ...
              itemBuilder: (context, snapshot, animation, index) {
                ...
                return ListTile(
                  ...
                  //-----LEADING (HERO ANIMATION) PICTURE----
                  leading: Hero(
                    tag: heroTag,
                    child: InkWell(
                      onTap: () {
                  ...
                  /// PopupMenuButton provides options for updating and deleting the album.
                      ...
                      PopupMenuItem(
                        ...
                        child: ListTile(
                          onTap: () {
                            ...
                            //deleting the id node to delete all of it branch id/name/imageurl
                            databaseReference
...
//----when showing the hero if clicking the image it will grow big and will have transparent bg
