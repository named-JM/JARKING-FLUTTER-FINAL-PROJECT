...
class _DeveloperCardState extends State<DeveloperCard> {
  final List<Developer> developers = [
    Developer(
      ...
      githubUrl: 'https://github.com/named-JM',
      facebookUrl: 'https://www.facebook.com/JM.cags',
    ),
    Developer('Carl Balano', 'Mobile Application Developer',
        ...
        githubUrl: 'https://github.com/FlamingSkies',
        facebookUrl: 'https://www.facebook.com/carlfrancis.balano'),
    // Developer(
    //   'King Martinez',
    //   'IT Assistant',
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      icon: Image.asset(
                        'Assets/images/github_icon.png', // Replace with your GitHub icon image
                        width: 60,
                        height: 50,
                      ),
                      iconSize: 35,
                    ...
                    IconButton(
                      icon: Image.asset(
                        'Assets/images/facebook_icon.png', // Replace with your Facebook icon image
                        width: 60,
                        height: 60,
                      ),
                      iconSize: 45,
                      onPressed: () {
                        launch(developer.facebookUrl);
                      },
                    ),
                  ],
                ),
